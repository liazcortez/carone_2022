...
const StepperView = ({...rest}) => {
  ...
  const steps = [
    'Cuentanos sobre la unidad',
    'Lugar de la unidad',
    'Descripción extra la unidad',
    'Tus Datos',
  ];
            ...
            <Stepper alternativeLabel activeStep={activeStep} connector={<QontoConnector />}>
                ...
                <Fragment>
                  <Grid item sm={12}>
                    <Box display={'flex'} justifyContent='center' mb={2}>
                      <Typography variant='h6'>Cuentanos más sobre la unidad</Typography>
                    </Box>
                  </Grid>
              ...
              }
              {
                ...
                <Fragment>
                  <Grid item sm={12}>
                    <Box display={'flex'} justifyContent='center' mb={2}>
                      <Typography variant='h6'>¿Dónde se encuentra la unidad?</Typography>
                    </Box>
                  </Grid>
                  <Grid item sm={12} md={6}>
                    <TextField
              ...
              }
              {
                ...
                <Fragment>
                  <Grid item sm={12}>
                    <Box display={'flex'} justifyContent='center' mb={2}>
                      <Typography variant='h6'>¿Tienes algún comentario extra relevante de la unidad?</Typography>
                    </Box>
                  </Grid>
                  <Grid item sm={12}>
              ...
              }
              {
                ...
                <Fragment>
                  <Grid item sm={12}>
                    <Box display={'flex'} justifyContent='center' mb={2}>
                      <Typography variant='h6'>¿Con quien nos debemos poner en contacto?</Typography>
                    </Box>
                  </Grid>
