  ...
  return (
    <Grid container spacing={2} style={{padding:"15px", marginTop:"4%"}}>
        ...
        <Grid item xs={12} md={6} style={{padding:"15px"}}>
            <Box style={{textAlign:"center"}}><Typography variant="h2"style={{fontWeight:"600", fontSize:"36px", lineHeight:"52px"}}>Nuestra Mision</Typography></Box>
            <Typography variant="body2" style={{fontSize:"17px", lineHeight:"1.5"}}>
