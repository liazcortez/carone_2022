    ...
    <Grid container spacing={2} style={{padding:"15px", marginTop:"2%", justifyContent:"center"}}>
        <Grid item xs={12}>
            <Box style={{width:"100%", padding:"10px", textAlign:"center"}}>
                <Typography variant="h2" style={{color:"#475066", fontWeight:"600", fontSize:"39px", lineHeight:"52px"}}>Conoce mas de nosotros</Typography>
            </Box>
        </Grid>
